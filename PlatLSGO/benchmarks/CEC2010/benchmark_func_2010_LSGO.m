...
function fit = benchmark_func_2010_LSGO(x, func_num)
x=x';
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        o = o';
        save 'input_data_10_LSGO/f01_o.mat' o;
    else
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
        save 'input_data_10_LSGO/f02_o.mat' o;
    else
        load 'input_data_10_LSGO/f02_o.mat';
        o = o(1:D);
    end
    initial_flag = 1;
end
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
        save 'input_data_10_LSGO/f03_o.mat' o;
    else
        load 'input_data_10_LSGO/f03_o.mat' o;
        o = o(1:D);
    end
    initial_flag = 1;
end
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        save 'input_data_10_LSGO/f04_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f04_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f05_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f05_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f06_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f06_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f07_op.mat' o p;
    else
        load 'input_data_10_LSGO/f07_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f08_op.mat' o p;
    else
        load 'input_data_10_LSGO/f08_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f09_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f09_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f10_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f10_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f11_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f11_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f12_op.mat' o p;
    else
        load 'input_data_10_LSGO/f12_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f13_op.mat' o p;
    else
        load 'input_data_10_LSGO/f13_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f14_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f14_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f15_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f15_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
        M = jrand.createRotMatrix(m);
        save 'input_data_10_LSGO/f16_opm.mat' o p M;
    else
        load 'input_data_10_LSGO/f16_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f17_op.mat' o p;
    else
        load 'input_data_10_LSGO/f17_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
        save 'input_data_10_LSGO/f18_op.mat' o p;
    else
        load 'input_data_10_LSGO/f18_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
        save 'input_data_10_LSGO/f19_o.mat' o;
    else
        load 'input_data_10_LSGO/f19_o.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub-1);
        o = o';
        save 'input_data_10_LSGO/f20_o.mat' o;
    else
        load 'input_data_10_LSGO/f20_o.mat';
    end
    if (D ~= 1000)
