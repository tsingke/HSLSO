...
function fit = benchmark_func_2013_LSGO(x, func_num)
global initial_flag
persistent fhd
persistent fid
...
function fit = f1(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f01.mat';
        initial_flag = 1;
    end
...
function fit = f2(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f02.mat';
        initial_flag = 1;
    end
...
function fit = f3(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f03.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f04.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f05.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f06.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f07.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f08.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f09.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f10.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f11.mat';
        initial_flag = 1;
    end
...
function fit = f12(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f12.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 m c lb ub w
    ...
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f13.mat';
        c = cumsum(s);
        initial_flag = 1;
...
persistent xopt p s R25 R50 R100 m c lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f14.mat';
        c = cumsum(s);
        initial_flag = 1;
    end
...
function fit = f15(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'input_data_13_LSGO/f15.mat';
        initial_flag = 1;
    end
...
% Check if numevals is allowed
if numevals <= maxevals
    if numevals >= next_milestone % Changed to >= to handle large pop
        file = fopen(bench_output_name, 'at');
        fprintf(file, '%d,%d,%e\n', numevals, fid, bench_bestfit);
        fclose(file);
        if next_milestone_i < length(bench_milestones)
            next_milestone_i = next_milestone_i + 1;
            next_milestone = bench_milestones(next_milestone_i);
        else
            next_milestone = inf; % Prevent further updates
        end
    end
end
end